...
void Application::poligosOP(int caras, int r)
{
...
//pones num pal poligon
void Application::setUpPoli()
{
	poligosOP(3, 100);
	setColor(255, 255, 0, 255);
}
/*------------------------------------------------------------------------------------------------------------------------------------------------------------*/
void Application::drawPoli()
{
	int size = VectorOP.size();

	for (int i = 0; i < VectorOP.size(); ++i) {
		moveTo(VectorOP.at(i).v[0], VectorOP.at(i).v[1]);
		lineTo(VectorOP.at((i + 1) % VectorOP.size()).v[0], VectorOP.at((i + 1) % VectorOP.size()).v[1]);
	}
	lineTo(255, 255);
}
